...
SelfPhi = TypeVar("SelfPhi", bound="PhiUpdate")


class PhiUpdate(OnPolicyAlgorithm):
    """
    ...
    :param kl_coef: KL function coefficient for the kl calculation
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                policy_loss = (-self.phi(self.eta * advantages) * ratio).mean()
